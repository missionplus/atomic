...
agent: 'agent'
---
<!-- GENERATED from skills/update-fake/SKILL.md by scripts/sync-skills.py. Do not edit by hand. -->
...
> Reference reading:
> - `../../skills/update-fake/reference/diff-strategy.md` — how to run and interpret each drift signal
> - `../../skills/update-fake/reference/changelog-template.md` — how to update `CHANGES.md` and bump the manifest
...
- Append an entry to `/fake/CHANGES.md` using `../../skills/update-fake/reference/changelog-template.md`.
